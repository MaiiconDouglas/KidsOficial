...
public class ProdutosRegistroActivity {

    private RegistoActivity.ViewHolder mViewHolder = new RegistoActivity.ViewHolder();
    private DBHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_registo);
        ...
        mViewHolder.et_username = findViewById(R.id.cd_cadastro_descricao);
        ...
        db = new DBHelper(this);  // Puxando dados banco porém ainda não registrando no mesmo.
        ...
        mViewHolder.bt_registar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty())
                    ...
                    Toast.makeText(RegistoActivity.this, "Insira e repita o password", Toast.LENGTH_SHORT).show();
                    ...
                    if (res > 0) {
                        Toast.makeText(RegistoActivity.this, "Usuário registado com sucesso!!", Toast.LENGTH_SHORT).show();
                        Intent i = getIntent();
                        i.putExtra("username", username);
                        setResult(1, i);
                        finish();
                    } else {
                        Toast.makeText(RegistoActivity.this, "Erro ao registar o Usuário!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
